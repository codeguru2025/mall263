...
CREATE TABLE "stall_analytics_events" (
    "id" UUID NOT NULL,
    "stall_id" UUID NOT NULL,
...
CREATE INDEX "stall_expenses_stall_id_occurred_at_idx" ON "stall_expenses"("stall_id", "occurred_at");
CREATE INDEX "stall_expenses_category_idx" ON "stall_expenses"("category");

CREATE INDEX "stall_analytics_events_stall_id_created_at_idx" ON "stall_analytics_events"("stall_id", "created_at");
CREATE INDEX "stall_analytics_events_stall_id_type_created_at_idx" ON "stall_analytics_events"("stall_id", "type", "created_at");
CREATE INDEX "stall_analytics_events_product_id_idx" ON "stall_analytics_events"("product_id");
